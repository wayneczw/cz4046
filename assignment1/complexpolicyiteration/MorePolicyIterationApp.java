...
public class MorePolicyIterationApp{
    ...
    public static State[][] loadStates() {
        ...
        */
        ...
        for(String wall : wallCoords) {
            ...
            stateArr[r*4][c*4] = new State(WALL_REWARD, "WALL");
        }
        ...
        */
        ...
        for(String green : greenCoords) {
            ...
            stateArr[r*4][c*4] = new State(GREEN_REWARD, "GREEN");
        }
        ...
        */
        ...
        for(String brown : brownCoords) {
            ...
            stateArr[r*4][c*4] = new State(BROWN_REWARD, "BROWN");
        }
